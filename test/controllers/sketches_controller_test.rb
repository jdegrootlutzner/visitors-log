...
class SketchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sketch" do
    assert_difference("Sketch.count") do
      post sketches_url, params: { sketch: { artist: @sketch.artist, upvotes: @sketch.upvotes } }
    end
  ...
  test "should update sketch" do
    patch sketch_url(@sketch), params: { sketch: { artist: @sketch.artist, upvotes: @sketch.upvotes } }
